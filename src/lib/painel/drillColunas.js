...
export const COLUNAS = {
  ...
  ItemCompra: { link: '/compras', cols: [c('Emissão', (r) => r.data_emissao), c('Fornecedor', (r) => r.fornecedor), c('Descrição', (r) => r.descricao || r.numero_nota), c('Valor', (r) => money(r.valor_total))] },
