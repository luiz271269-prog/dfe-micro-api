    ...
    <div className="lg:px-6 lg:py-6 max-w-[1600px] mx-auto space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5 flex-wrap px-48">
          ...
          className={`rounded-lg font-bold transition-all text-sm px-4 text-[hsl(var(--primary-foreground))] ${!isAnnual && selectedMonth === m ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-md' : "border hover:bg-muted"}`}>
              {fmtMes(m)}
            </button>
          )}
