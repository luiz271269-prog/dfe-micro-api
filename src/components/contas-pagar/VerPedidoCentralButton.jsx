...
export default function VerPedidoCentralButton({ compra }) {
  ...
  function abrirPedido(event) {
    ...
    const url = new URL('https://nexus-cotacoes360.base44.app/pedidos');
    url.searchParams.set('oc_numero', compra.pedido_central_id);
    if (compra.pedido_central_internal_id) url.searchParams.set('item', compra.pedido_central_internal_id);
