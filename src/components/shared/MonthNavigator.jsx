        ...
        {ALL_MONTHS.slice(-5).map((m) => {
          ...
          return (
            <button
              ...
              className={`px-2.5 py-1.5 rounded-lg text-xs font-semibold transition-all flex flex-col items-center min-w-[60px] bg-[hsl(var(--sidebar-ring))] text-[hsl(var(--chart-4))] ${
              isActive ?
